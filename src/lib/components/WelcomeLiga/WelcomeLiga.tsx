...
import './WelcomeLiga.css';

const WelcomeLigaComponent: React.FC = () => {
  return (
    <div className="mt-40 flex h-screen w-full flex-col items-center justify-center space-x-8 space-y-16 lg:mt-0 lg:flex-row lg:space-y-0 2xl:space-x-0">
      <div className="flex w-full flex-col items-center justify-center text-center lg:w-1/2 lg:px-2 xl:px-0">
        <p className="text-gray-300 text-7xl font-bold tracking-wider md:text-8xl lg:text-9xl">
          Olá!
        </p>
        <p className="text-gray-300 mt-2 p-2 text-4xl font-bold tracking-wider md:text-5xl lg:text-6xl">
          BEM VINDO A LIGA!
        </p>
        <p className="text-gray-500 my-0 p-10 text-lg md:text-xl lg:my-12 lg:p-2 lg:text-2xl">
          para desfrutar e conhecer melhor nosso projeto, faça seu cadastro e
          aproveite!
        </p>
        <a
          href="#"
        ...
        >
          <span>
            <Link href="/register">
              <button className="brutalist-button mt-10 flex" type="submit">
                <div className="w-full items-center justify-center space-x-3 rounded-full bg-white">
                  <Image
                    alt="Logo"
                    width="80"
                    height="80"
...
export default WelcomeLigaComponent;
