                        ...
                        <Layout maxW={"container.xl"}>
                            ...
                            >
                                ...
                                <Box size="xl" display="flex" justifyContent={"center"} alignItems={"center"}>
                                    <Text>
                                        Caso ainda não tenha feito o cadastro,<a href="/register"> <Text as="span" _hover={{textDecoration: "underline"}} cursor={"pointer"} color={"#1485E8"} href="/register"> clique aqui.</Text></a>
                                    </Text>
                                </Box>
                                <Box size="xl">
                                    <HStack>
